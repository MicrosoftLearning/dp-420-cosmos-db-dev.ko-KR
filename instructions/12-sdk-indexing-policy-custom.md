...
1. [Path][docs.microsoft.com/dotnet/api/microsoft.azure.cosmos.excludedpath.path] 속성이 *policy* 변수의 [ExcludedPaths][docs.microsoft.com/dotnet/api/microsoft.azure.cosmos.indexingpolicy.excludedpaths] 컬렉션 속성에 대한 **/*** 값으로.
